...
from .views import login42, get_authorize_url, get_profile_image, get_infos_user, get_jwt_token, validate_2fa, enable_2fa, disable_2fa, get_qrcode, signup, signin, logout
