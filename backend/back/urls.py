...
from back.views import signintournament, checkalias, add_friend, del_friend, get_following, begintournament, updatetournament, endtournament, pong2phistory, pong3phistory, stats_games, list_games, ttthistory
